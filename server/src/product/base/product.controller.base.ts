...
import { ScanHistoryFindManyArgs } from "../../scanHistory/base/ScanHistoryFindManyArgs";
...
export class ProductControllerBase {
  ...
  async findManyScanHistory(
    @common.Req() request: Request,
    @common.Param() params: ProductWhereUniqueInput,
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<ScanHistory[]> {
    const query = plainToClass(ScanHistoryFindManyArgs, request.query);
    const permission = this.rolesBuilder.permission({
      role: userRoles,
      action: "read",
      possession: "any",
    ...
    const results = await this.service.findScanHistory(params.id, {
      ...query,
      select: {
        createdAt: true,
        id: true,
